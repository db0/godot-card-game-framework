...
func test_single_card_focus():
	...
	assert_almost_eq(Vector2(47.5, -120),cards[0].position,Vector2(2,2), "Check card dragged in correct global position")
...
func test_card_focus_neighbour_push():
	...
	yield(yield_for(1), YIELD)
	assert_almost_eq(Vector2(29, 120),cards[0].position,Vector2(2,2), "Check card dragged in correct global position")
	assert_almost_eq(Vector2(137.5, 120),cards[1].position,Vector2(2,2), "Check card dragged in correct global position")
	assert_almost_eq(Vector2(692.5, 120),cards[3].position,Vector2(2,2), "Check card dragged in correct global position")
	assert_almost_eq(Vector2(801.25, 120),cards[4].position,Vector2(2,2), "Check card dragged in correct global position")
